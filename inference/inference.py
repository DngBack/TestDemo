...
from TRACER.util.dataloader import get_test_augmentation, get_loader
...
class Inference:
    ...
    def test(self):
        ...
        with torch.no_grad():
            for i, (images, original_size, image_name) in enumerate(
                ...
                for i in range(images.size(0)):
                    ...
                    output = F.interpolate(
                        outputs[i].unsqueeze(0), size=(h, w), mode="bilinear"
                    )
